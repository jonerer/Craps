...
namespace Craps
{
    ...
    class Tests
    {
        ...
        public void TestCombinations()
        {
            ...
            Assert.AreEqual(MainWindow.CrackingCombinations(fivenumbers, alphasource, alpha), 
                MainWindow.CrackingCombinations(fivenumbers,alphasource,pass));
            Assert.AreEqual(MainWindow.CrackingCombinations(fivewords, en, pass), new BigInteger("36893488147419103232"));
            Assert.AreEqual(MainWindow.CrackingCombinations(sixwords, en, pass), new BigInteger("302231454903657293676544"));

            Assert.AreEqual(MainWindow.CrackingCombinations(fivewords, en, alpha), new BigInteger("11361668153983839080134359106715648"));
        }
        ...
        public void TestCrackingTime()
        {
            ...
            var alphaCombos = MainWindow.CrackingCombinations(twoWords, en, alpha);
            var passCombos = MainWindow.CrackingCombinations(twoWords, en, pass);
            ...
            Assert.AreEqual("6 days", MainWindow.CrackingTimeNatural(alphaCombos, HashesPerSecond));
            Assert.AreEqual("11 minutes", MainWindow.CrackingTimeNatural(passCombos, HashesPerSecond));
        }
    }
}
